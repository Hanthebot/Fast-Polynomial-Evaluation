...
OBJS_MULT   = nd_fft.o nd_fft_helper.o fft_brutal.o fft_compute.o util_math.o util_multivar.o gfelement.o galoisfield.o modular_arith.o nd_vector.o
...
fft_brutal.o: fft_multivar/fft_brutal.cpp fft_multivar/fft_multivar.h
	$(CC) $(LFLAGS) fft_multivar/fft_brutal.cpp $(GMP)
