...
// changed
void fft(const F* w, F* const& arr, const map<F, u32>& dlog, const u32* rev, u32 logn, Fint& mul_counter, F& u, F& v);
void fft_multivar_recur(const F* w, const nd_vector<F>& arr, const map<F, u32>& dlog, const u32* rev, u32 logn, Fint& mul_counter, nd_vector<F>& temp_u, nd_vector<F>& temp_v);
...
void fft_nd(const F* w, const nd_vector<F>& arr, const map<F, u32>& dlog, const u32* rev, u32 logn, Fint& mul_counter, nd_vector<F>& temp_u, nd_vector<F>& temp_v);
