...
void fft_multivar_wrapper_NF(const F* w, nd_vector<F>& arr, const vector<u32>& radix_vec, const vector<u32>& dist, const vector<u32>* rev_rev, Fint& mul_counter, F*& temp_u_vec, F*& temp_v1_vec, F*& temp_v2_vec);
